...
def help_user(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ JOIN OUR CHANNEL ⭕️", url="https://t.me/z_harbour")]]),
        parse_mode="html",
...
def send_start(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ Group ⭕️", url="https://t.me/blackest_harbour")], [InlineKeyboardButton(text="😇 Group 2.0", url="https://t.me/z_harbour_files"),
